...
if Params.suite2pMode == 0
   ...
   eMetl = {'number of active electrodes', ...
            ...
            'Unit average burst rate (per minute)', ...
            'Unit average burst duration (ms)', ...
            'Unit average ISI within burst (ms)', ... 
            'Unit average ISI outside burst (ms)', ... 
            'Channel average fraction of spikes in bursts', ...
            }; 
else 
