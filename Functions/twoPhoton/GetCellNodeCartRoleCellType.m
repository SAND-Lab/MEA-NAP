...
expMatFolder = 'D:\MEA-NAP\OutputData14Apr2025(AllPolled&Truncated)\ExperimentMatFiles';
csvSavePath = 'D:\MEA-NAP\OutputData14Apr2025(AllPolled&Truncated)\NCnodes.csv';
...
% === CONFIG ===
ncCsvPath = 'D:\MEA-NAP\OutputData14Apr2025(AllPolled&Truncated)\NCnodes.csv';
cellTypecsvFolder = 'Z:\Yin (yy433)\StatisticalTest\splitNPY\CellType_Priority1';
outputCsvPath = 'D:\MEA-NAP\OutputData14Apr2025(AllPolled&Truncated)\NC_CellType.csv';

% Path to save the unmatched log
logFilePath = 'D:\MEA-NAP\OutputData14Apr2025(AllPolled&Truncated)\Missing IDs from CellTypeCSVFile unmatched to MEANAPchannels.txt';
