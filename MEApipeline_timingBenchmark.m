function MEApipeline_timingBenchmark(InputParamsFilePath)
...
%
% =====================================================================
% BENCHMARK SCRIPT — headless (Params.guiMode=0) copy of MEApipeline.m,
% for timing a full steps-1-4 run on ExampleData/ (recordings A2/A3) to
% compare against the Python port's Params.time_processes timing
% (src/meanap/pipeline/runner.py). Only the "Directories"/settings
% section below (through "Params.guiMode = 0") differs from the real
% MEApipeline.m — the rest of the file is an unmodified copy, plus one
% small inline patch further down (search "NOTE:" / "DEBUG:").
%
% Run: matlab -batch "MEApipeline_timingBenchmark"
% Output: /home/timsit/MEA-NAP/matlab_timing_benchmark_out/OutputDataTimingBenchmark
% Log convention used so far: /tmp/.../matlab_timing_run.log (see chat
% history / PIPELINE_PORT_STATUS.md for this session's specifics — that
...
Params.outputDataFolder = '/home/timsit/MEA-NAP/matlab_timing_benchmark_out';
Params.outputDataFolderName = 'OutputDataTimingBenchmark';
