...
spikeDetectedData = '/media/timothysit/Elements/MAT_files/AnalysisPipeline/OutputData11Nov2022'; % path to spike-detected data
...
if any(strcmp(Params.optionalStepsToRun,'runStats'))
    ...
    recordingLevelDataPath = '/Users/timothysit/AnalysisPipeline/mecp2-16Dec2022/NetworkActivity_RecordingLevel.csv';
    recordingLevelData = readtable(recordingLevelDataPath);
    
    nodeLevelDataPath = '/Users/timothysit/AnalysisPipeline/mecp2-16Dec2022/NetworkActivity_NodeLevel.csv';
    nodeLevelData = readtable(nodeLevelDataPath);

    divValues = recordingLevelData.DIV;
    divValues(divValues == 34) = 35;
    recordingLevelData.DIV = divValues;
    plotSaveFolder = '/Users/timothysit/AnalysisPipeline/mecp2-16Dec2022';

    Params.clfFeaturesToUse = {'aN', 'Dens', 'CC', 'nMod', 'Q', 'PL', 'Eglob', 'SW', 'SWw', 'effRank', 'num_nnmf_components'};
    ...
    Params.plotSortedWeights = 1;
    Params.clfDoRFE = 1;
    Params.RFEmaxFeaturesToRemove = 3;
