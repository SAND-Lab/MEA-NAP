...
------------------------------
- The choice of parameters depends on your data and scientific question. Thus, it is helpful to use the validation plots in MEA-NAP to confirm which parameter choices are appropriate for your data.  MEA-NAP can run autonomously from Step 1-5.  MEA-NAP can also be run in steps to help you determine the choice of parameters.  See MEA-NAP Methods for more detail.
