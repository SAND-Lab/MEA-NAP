...
- **MEA-NAP Folder:** Location of the MEA-NAP folder you downloaded from our Github page.  Please move the note about recommend save in Documents Folder and not in Program Files to the Setting up MEA-NAP page.  **_Important: there may be a brief pause before the file browser appears after you click the select buttons in the GUI. Do not click on other parts of the GUI during this pause._** Otherwise, you may need to close the GUI, clear the workspace, and run MEA-NAP again.
