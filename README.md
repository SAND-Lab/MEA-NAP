...
Here is an example screenshot of MEA-NAP, on the right, you have the interface to set your parmeters for performing analysis, and on the left, you have a viewer that allows you to browse through the outputs of MEA-NAP.
