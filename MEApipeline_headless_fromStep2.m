function MEApipeline_headless_fromStep2(InputParamsFilePath)
...
Params.outputDataFolderName = 'OutputDataExampleRun2FromStep2_canonicalTest'; % EDIT: name for this run's output subfolder
rawData = '/imaging/astle/alex/MEA-NAP-storage/ExampleData';             % EDIT: folder of "<name>.mat" channel-placeholder (or real raw) files
Params.priorAnalysisPath = [''];   % leave empty -- not used when priorAnalysis=0
spikeDetectedData = '/imaging/astle/alex/MEA-NAP-storage/OutputData/OutputDataExampleRun1/1_SpikeDetection/1A_SpikeDetectedData'; % EDIT: folder of "<name>_spikes.mat" files

% Input and output filetype
spreadsheet_file_type = 'csv'; % 'csv' or 'excel'
spreadsheet_filename = '/imaging/astle/alex/MEA-NAP-storage/ExampleData/exampleData_subset.csv'; % EDIT: batch CSV (filename, DIV, group[, Ground])
