...
% Directories
HomeDir = '/Users/timothysit/AnalysisPipeline'; % Where the Aanlysis pipeline code is located
Params.outputDataFolder = '/Users/timothysit/AnalysisPipeline/temp/tempHPC';   % Where to save the output data, leave as '' if same as HomeDir 
rawData = '';  % path to raw data .mat files
Params.priorAnalysisPath = ['/Users/timothysit/AnalysisPipeline/temp/tempHPC/OutputData07Jul2023'];  % path to prev analysis, leave as [''] if no prior anlaysis
...
Params.priorAnalysisDate = '07Jul2023'; % prior analysis date in format given in output data folder e.g., '27Sep2021'
